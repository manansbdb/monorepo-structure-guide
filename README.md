...
<p align="center">
  <strong>EN</strong> Suggested layouts for application and package monorepos.<br/>
  <strong>PT</strong> Layouts sugeridos para monorepos de aplicações e pacotes.
</p>
...
| English | Português |
|---------|-----------|
| Suggested layouts for application and package monorepos. | Layouts sugeridos para monorepos de aplicações e pacotes. |
...
- `layouts.md` — structure options / opções de estrutura
- `tooling-notes.md` — tooling tips / notas de tooling
